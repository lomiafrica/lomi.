...
export async function applyCoupon(
  ...
  if (options === null) {
    return callRpc(client, "apply_coupon", args, "apply_coupon", {
      fallbackValue: null,
    });
  }
...
export async function validateCouponForFrontend(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["validate_coupon_for_frontend"]["Returns"]
  > | null,
): Promise<
  DbFunctions["validate_coupon_for_frontend"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function createOrUpdateCustomer(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["create_or_update_customer"]["Returns"]
  > | null,
): Promise<
  DbFunctions["create_or_update_customer"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function fetchDataForCheckout(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["fetch_data_for_checkout"]["Returns"]
  > | null,
...
export async function fetchOrganizationDetailsCheckout(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["fetch_organization_details_checkout"]["Returns"]
  > | null,
): Promise<
  DbFunctions["fetch_organization_details_checkout"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function getMerchantFromOrganization(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["get_merchant_from_organization"]["Returns"]
  > | null,
): Promise<
  DbFunctions["get_merchant_from_organization"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function getCheckoutColors(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["get_checkout_colors"]["Returns"]
  > | null,
): Promise<DbFunctions["get_checkout_colors"]["Returns"] | null | boolean> {
  if (options === null) {
    return callRpc(client, "get_checkout_colors", args, "get_checkout_colors", {
      fallbackValue: null,
    });
  }
  return callRpc(
...
export async function getPostCheckoutDetails(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["get_post_checkout_details"]["Returns"]
  > | null,
): Promise<
  DbFunctions["get_post_checkout_details"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function updateCheckoutSessionCustomer(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["update_checkout_session_customer"]["Returns"]
  > | null,
): Promise<
  DbFunctions["update_checkout_session_customer"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function recordPendingStripeTransaction(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["record_pending_stripe_transaction"]["Returns"]
  > | null,
): Promise<
  DbFunctions["record_pending_stripe_transaction"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function recordStripeCheckoutFailure(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["record_stripe_checkout_failure"]["Returns"]
  > | null,
): Promise<
  DbFunctions["record_stripe_checkout_failure"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function createMtnTransaction(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["create_mtn_transaction"]["Returns"]
  > | null,
...
export async function updateMtnProviderReference(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["update_mtn_provider_reference"]["Returns"]
  > | null,
): Promise<
  DbFunctions["update_mtn_provider_reference"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function completeSubscriptionSignupWithoutPayment(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["complete_subscription_signup_without_payment"]["Returns"]
  > | null,
): Promise<
  | DbFunctions["complete_subscription_signup_without_payment"]["Returns"]
  | null
...
export async function fetchCheckoutProcessingFeeRates(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["fetch_checkout_processing_fee_rates"]["Returns"]
  > | null,
): Promise<
  DbFunctions["fetch_checkout_processing_fee_rates"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function resolveSubscriptionSignupTerms(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["resolve_subscription_signup_terms"]["Returns"]
  > | null,
): Promise<
  DbFunctions["resolve_subscription_signup_terms"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function recordDownloadAccess(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["record_download_access"]["Returns"]
  > | null,
...
export async function validateDownloadAccessToken(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["validate_download_access_token"]["Returns"]
  > | null,
): Promise<
  DbFunctions["validate_download_access_token"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
