...
export async function broadcastNotification(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["broadcast_notification"]["Returns"]
  > | null,
...
export async function completeManualRefundRequest(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["complete_manual_refund_request"]["Returns"]
  > | null,
): Promise<
  DbFunctions["complete_manual_refund_request"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function getProfitabilityBaseline(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["get_profitability_baseline"]["Returns"]
  > | null,
): Promise<
  DbFunctions["get_profitability_baseline"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function getProfitabilityBaselineForMonth(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["get_profitability_baseline_for_month"]["Returns"]
  > | null,
): Promise<
  | DbFunctions["get_profitability_baseline_for_month"]["Returns"]
  | null
...
export async function managePlatformExpense(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["manage_platform_expense"]["Returns"]
  > | null,
...
export async function manualAdjustChannelBalance(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["manual_adjust_channel_balance"]["Returns"]
  > | null,
): Promise<
  DbFunctions["manual_adjust_channel_balance"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function restoreMerchant(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["restore_merchant"]["Returns"]
  > | null,
): Promise<DbFunctions["restore_merchant"]["Returns"] | null | boolean> {
  if (options === null) {
    return callRpc(client, "restore_merchant", args, "restore_merchant", {
      fallbackValue: null,
    });
  }
...
export async function rejectManualRefundRequest(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["reject_manual_refund_request"]["Returns"]
  > | null,
): Promise<
  DbFunctions["reject_manual_refund_request"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function updateAdminDashboardAccessConfig(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["update_admin_dashboard_access_config"]["Returns"]
  > | null,
): Promise<
  | DbFunctions["update_admin_dashboard_access_config"]["Returns"]
  | null
...
export async function updateAdminOrganizationSettings(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["update_admin_organization_settings"]["Returns"]
  > | null,
): Promise<
  DbFunctions["update_admin_organization_settings"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
...
export async function updatePlatformSettingJson(
  ...
  options?: SupabaseRpcOptions<
    DbFunctions["update_platform_setting_json"]["Returns"]
  > | null,
): Promise<
  DbFunctions["update_platform_setting_json"]["Returns"] | null | boolean
> {
  if (options === null) {
    return callRpc(
      client,
