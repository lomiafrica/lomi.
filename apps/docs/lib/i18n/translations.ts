...
const STRINGS: TranslationsByLanguage = {
  en: {
    ...
    'docs.shell.accountMenu': 'Menu',
    'docs.shell.dashboard': 'Dashboard',
    'docs.shell.language': 'Language',
    'docs.shell.theme': 'Theme',
    'docs.shell.theme.light': 'Light',
    'docs.shell.theme.dark': 'Dark',
    'docs.shell.theme.system': 'System',
    'docs.shell.mcp': 'MCP',
    'docs.shell.mcpSetup': 'Setup',
    'docs.shell.website': 'Website',
    'docs.shell.github': 'GitHub',
    'docs.shell.status': 'Status',
    'mcpConnect.addCursor': 'Add to Cursor',
    'mcpConnect.addGrok': 'Add to Grok Bot',
    'mcpConnect.addClaude': 'Add to Claude',
    'mcpConnect.addVscode': 'Add to VS Code',
    ...
    'mcpIndex.search': 'Search tools or actions',
    'mcpIndex.empty': 'No matching tools',
    'mcpIndex.filters': 'Tool categories',
    'mcpIndex.category.accept': 'Accept payments',
    'mcpIndex.category.commerce': 'Manage commerce',
    'mcpIndex.category.money': 'Move money',
    'mcpIndex.category.platform': 'Platform',
    'mcpIndex.category.operations': 'Operations',
    'mcpIndex.category.agents': 'Agents',
  ...
  fr: {
    'search.all': 'Tout',
    'search.start': 'Démarrer',
    'search.build': 'Construire',
    'search.api': 'API',
    ...
    'docs.shell.accountMenu': 'Menu',
    'docs.shell.dashboard': 'Tableau de bord',
    'docs.shell.language': 'Langue',
    'docs.shell.theme': 'Thème',
    'docs.shell.theme.light': 'Clair',
    'docs.shell.theme.dark': 'Sombre',
    'docs.shell.theme.system': 'Système',
    'docs.shell.mcp': 'MCP',
    'docs.shell.mcpSetup': 'Mise en route',
    'docs.shell.website': 'Site',
    'docs.shell.github': 'GitHub',
    'docs.shell.status': 'Statut',
    'mcpConnect.addCursor': 'Ajouter à Cursor',
    'mcpConnect.addGrok': 'Ajouter à Grok Bot',
    'mcpConnect.addClaude': 'Ajouter à Claude',
    'mcpConnect.addVscode': 'Ajouter à VS Code',
    ...
    'mcpIndex.search': 'Rechercher un outil ou une action',
    'mcpIndex.empty': 'Aucun outil correspondant',
    'mcpIndex.filters': 'Catégories d’outils',
    'mcpIndex.category.accept': 'Encaisser des paiements',
    'mcpIndex.category.commerce': 'Gérer votre commerce',
    'mcpIndex.category.money': 'Mouvements d’argent',
    'mcpIndex.category.platform': 'Plateforme',
    'mcpIndex.category.operations': 'Opérations',
    'mcpIndex.category.agents': 'Agents',
