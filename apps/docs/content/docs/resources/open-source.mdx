...
| Area | Availability |
| :--- | :--- |
| Hosted payment platform (API, dashboard, checkout, MoR) | ✅ Production, [sign up](https://dashboard.lomi.africa) |
...
For production payments, use the hosted platform on [dashboard.lomi.africa](https://dashboard.lomi.africa). You get built-in payment channels, Merchant of Record coverage, automatic updates, and dedicated support.
