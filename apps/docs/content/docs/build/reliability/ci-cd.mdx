...
# .env.ci
LOMI_SECRET_KEY=lomi_sk_test_... # Use a dedicated test key
...
Run your integration tests against lomi. sandbox environment on pushes and pull requests.
  ...
  test:
    ...
    steps:
      ...
      - name: Run tests
        run: npm test
        env:
          LOMI_SECRET_KEY: ${{ secrets.LOMI_TEST_SECRET_KEY }} # Use GitHub secrets
...
<DocsNextSteps>
  <DocsNextStep href="/build/reliability/testing" hint="What to automate">
    Testing guide
  </DocsNextStep>
