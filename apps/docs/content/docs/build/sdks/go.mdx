...
Official Go SDK for lomi.. payments API. Works with any Go 1.18+ application.
...
| `PayoutsAPI`          | `ListPayouts`, `CreatePayout`, `RetrievePayout` (self and beneficiary via `destination`)                                   |
