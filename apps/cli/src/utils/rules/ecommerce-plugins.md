...
- Custom site or landing page → [embed widget](https://docs.lomi.africa/build/accept/embed-widget)
...
- Hosted product catalog without a third-party store → [Products](https://docs.lomi.africa/build/billing/products) + store.lomi.africa
